            ...
            if (item != null) {
                if (amountInserted >= item.getPrice()) {
                    if (item.getQuantity() > 0) {
                        ...
                        System.out.println("Your Coke is ready. Thank you for your purchase!");
                    } else {
                        System.out.println("Coke is currently unavailable.");
